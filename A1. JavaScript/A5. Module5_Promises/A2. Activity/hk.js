...
browserStartPromise
    .then(function (browserObj) {
        ...
        //console.log("Login Page Opended");
        let emailWillBeEnteredPromise = page.type("input[id='input-1']", emailpassObj.email, { delay: 50 });
        return emailWillBeEnteredPromise; //email enter hogya
    }).then(function () { //ab password enter karenge
